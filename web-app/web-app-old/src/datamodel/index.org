...
|------------------------------------------+----------------------+-----------------------+-----------------------+---|
| viewUsers(s:Session)                     |                      | s:session-set         | success               |   |
|------------------------------------------+----------------------+-----------------------+-----------------------+---|
| createUser(e: Email, n:Name, s: Session) | s.user.role=admin    | s:session-set         |                       |   |
|                                          |                      | e:~email-set          |                       |   |
|------------------------------------------+----------------------+-----------------------+-----------------------+---|
| deleteUsers( u:User, s:Session)          | s.user.role=admin    | u:user-set            |                       |   |
|                                          | u.role!=admin        | s:session-set         | user-set decreases    |   |
|                                          |                      | u:~logged-in-user-set |                       |   |
|------------------------------------------+----------------------+-----------------------+-----------------------+---|
| getEmail(u: User, s:Session)             |                      | u:user-set            |                       |   |
|                                          |                      | s:session-set         | success               |   |
|------------------------------------------+----------------------+-----------------------+-----------------------+---|
...
|                                          |                      | u:user-set            | success               |   |
|------------------------------------------+----------------------+-----------------------+-----------------------+---|
| editEmail(u: User, e:Email, s:Session)   | s.user.role=admin or | u:user-set            | success               |   |
|                                          | s.user=u             | s:session-set         | user-set is updated   |   |
|------------------------------------------+----------------------+-----------------------+-----------------------+---|
| login(u: User, s:System)                 |                      | u:user-set            | session-set increases |   |
|                                          |                      |                       |                       |   |
|                                          |                      |                       |                       |   |
|------------------------------------------+----------------------+-----------------------+-----------------------+---|
| logOut( s:System, ss:Session-set)        |                      | ss:session-set        |                       |   |
|                                          |                      |                       | session-set decreases |   |
|------------------------------------------+----------------------+-----------------------+-----------------------+---|
| editRole(r: Role, s: Session, u: User)   | s.user.role=admin    | u: User-set           |                       |   |
|                                          |                      | s: Session-set        | success               |   |
|                                          |                      |                       | user-set updated      |   |
|------------------------------------------+----------------------+-----------------------+-----------------------+---|
| editName(n:Name, s: Session, u: User)    | s.user.role=admin or | u: User-set           |                       |   |
|                                          | s.user=u             | s: Session-set        | success               |   |
|                                          |                      |                       | user-set updated      |   |
|------------------------------------------+----------------------+-----------------------+-----------------------+---|
